    ...
    fn check(&self, file: &FileAnalysis, source: &str) -> Vec<Issue> {
        ...
        crate::analyzer::parser::with_parser(lang, source, |tree| {
            crate::analyzer::parser::visit_descendants(tree.root_node(), |node| {
                ...
                let Some(bound) = func.child_by_field_name("object") else {
                    return;
                };
                let Ok(bound_text) = bound.utf8_text(source.as_bytes()) else {
                    return;
                };
                ...
                if !bound_text.contains("this") {
                    ...
                    issues.push(Issue {
                        ...
                        message: "`.bind(this)` is unnecessary; the function doesn't use `this`."
                            .into(),
