...
impl Rule for PreferTemplate {
    fn id(&self) -> &'static str { "prefer-template" }
    fn name(&self) -> &'static str { "Prefer template literals" }
    ...
    fn check(&self, file: &FileAnalysis, source: &str) -> Vec<Issue> {
        ...
        crate::analyzer::parser::with_parser(lang, source, |tree| {
            crate::analyzer::parser::visit_descendants(tree.root_node(), |node| {
                ...
                if is_stringish(l) && (is_stringish(r) || matches!(r.kind(), "identifier" | "member_expression" | "call_expression")) {
